...
Ég býð upp á námskeið, gestakennslu, einkatíma, fjarþjálfun og ástundunartíma.

<div class="row">
    <div class="column"><img src="/images/pic01.jpg" width="90%" height="90%"/></div>
    <div class="column">
        <h3>Námskeið</h3>
            <p class="texti">Ég held reglulega helgarnámskeið þar sem að farið er yfir undirstöðuatriði handstöðulistarinnar. Námskeiðið hentar öllum.<br>
            <b>Lengra komnir</b> eru þeir sem komast á hvolf við vegg og líður ágætlega þar í 30 sekúndur eða lengur.<br>
            Næsta námskeið: <b>5. og 6. október</b>.<br>
            <b>Byrjendur</b>: 12.00-14.15<br>
            <b>Lengra komnir</b>: 14.30-16.45<br>
            <b>Verð</b>: 15.000 kr</p></p>
    </div>
</div>
<br>
<div class="row">
...
<div class="row">
    ...
    <div class="column">
        <h3>Fjarþjálfun</h3>
             <p class="texti">Fjarþjálfun er tilvalin fyrir þá sem komast ekki á námskeið eða vilja aðhald eftir námskeið.
             ...
             <br>
             <b>Verð</b>: 16.900 kr fyrir einn mánuð, 42.900 kr fyrir þrjá mánuði.</p>
    </div>
</div>
<br>
<div class="row">
    <div class="column">
        <h3>Ástundunartímar</h3>
            <p class="texti">Flesta þriðjudaga kl. 18.45-20.00 býð ég upp á handstöðu ástundunartíma í Primal Iceland.
            Eftir sameiginlega upphitun, þá iðkar hver og einn sína handstöðu með hjálp frá mér.<br>
            <b>Verð</b>: 2.500 kr skiptið. Frítt fyrir áskrifendur í Movement hjá Primal Iceland.</p>
    </div>
